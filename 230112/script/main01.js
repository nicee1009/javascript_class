$(function(){
  ...
  let img_w = $('.slide img').width();//이미지 너비를 자동으로 구해줌
  ...
  function moveRight(){
    $('.slide ul').animate({'margin-left':'0px'},500, function(){
      //오른쪽 마지막 li태그를 왼쪽 첫번째 li태그의 앞에다가 자리를 옮긴다.
      $('.slide li:last-child').insertBefore('.slide li:first-child');
      $('.slide ul').css('margin-left',-img_w);
    });
  }
  ...
  //4.좌,우 버튼 클릭시 각각 해당하는 호출하여 움직이게 하기
